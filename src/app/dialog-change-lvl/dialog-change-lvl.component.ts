  ...
  constructor(
    ...
    [
      {level: 0, levelName: 'novice', levelDesc: 'no usable knowledge'},
      {
        ...
        levelDesc: 'basic knowledge, performs basic tasks, requires supervision and training'
      },
      {
        level: 2,
        levelName: 'competent',
        levelDesc: 'performs regular tasks, requires mentoring and guidance on complex tasks'
      },
      {level: 3, levelName: 'proficient', levelDesc: 'performs any tasks with a hollistic view'},
      {
        level: 4,
        levelName: 'expert',
        levelDesc: 'expert on the topic capable of teaching others'
      }].forEach(i => this.skillVariants.push(
